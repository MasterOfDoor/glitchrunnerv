...
/// <summary>
/// Oyun başlarken HUD yoksa runtime'da oluşturur.
/// Böylece doğrudan CpuBazaar (veya herhangi bir sahne) açılıp Play'e basıldığında da HUD görünür.
/// </summary>
public static class RuntimeHUDBuilder
{
    ...
    public static void BuildHUD()
    {
        ...
        panelGO.AddComponent<Image>().color = new Color(0f, 0.85f, 0.3f, 0.55f);
        ...
        hud.balanceReader = reader;

        Debug.Log("[RuntimeHUDBuilder] HUD oluşturuldu.");
    }
        ...
        Transform parent, string name, Color fillColor, Color trackColor, float yOffset)
    {
        ...
        fRT.anchorMax = name == "BALANCE" ? new Vector2(0f, 1f) : new Vector2(1f, 1f);
